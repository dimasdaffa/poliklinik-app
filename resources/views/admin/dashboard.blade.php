            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="info-box bg-success">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="{{ route('dokter.index') }}" class="small-box-footer text-white">Lihat detail <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="info-box bg-warning">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="{{ route('pasien.index') }}" class="small-box-footer text-white">Lihat detail <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="info-box bg-danger">
                    ...
                    <div class="info-box-content">
                        ...
                        <a href="{{ route('obat.index') }}" class="small-box-footer text-white">Lihat detail <i class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
